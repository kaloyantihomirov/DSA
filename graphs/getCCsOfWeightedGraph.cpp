/*
Това е решението на следната задача от изпита от 2023/2024 по СДА на специалност Софтуерно инженерство към ФМИ, СУ: https://www.hackerrank.com/contests/2023-2024-2/challenges/components-mst-k/problem.
